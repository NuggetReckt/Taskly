...
export default function Home() {
    const featuresListData: FeatureCardData[] = [
        ...
        {
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                       strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-globe size-6 text-[#0E6BA8]">
                <circle cx="12" cy="12" r="10"></circle>
    ...
    return (
        <div className="welcomepage-wrapper">
            <div className={"welcomepage-header-wrapper"}>
                <div className={"welcomepage-header"}>
                    <h1 className={"welcomepage-header-title"}>Project Management, Simplified & Open</h1>
                    <p className={"welcomepage-header-subtitle"}>
                    ...
                    <div className={"welcomepage-header-btns"}>
                        <a className={"welcomepage-header-btn get-started-btn"} href="/app">
                        ...
                        <a className={"welcomepage-header-btn view-gh-btn"} href="https://github.com/NuggetReckt/Taskly" target={"_blank"}>
                    ...
                    <a className={"learn-more-btn"} href="#features">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor"
                             strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                             className="lucide lucide-arrow-right size-5 rotate-90">
                            <path d="M5 12h14"></path>
                            <path d="m12 5 7 7-7 7"></path>
                        </svg>
                    </a>
            ...
            <div className={"welcomepage-features welcomepage-section"} id={"features"}>
                <div className={"welcomepage-section-header"}>
                    <h1 className={"welcomepage-section-title"}>Everything You Need to Manage Projects</h1>
                    <span
                        className={"welcomepage-section-subtitle"}>Built with the latest technologies and designed for teams of all sizes</span>
                </div>
                <div className={"features-list"}>{featuresList}</div>
            </div>
            <div className={"welcomepage-pricing welcomepage-section"} id={"pricing"}>
                <div className={"welcomepage-section-header"}>
                    <h1 className={"welcomepage-section-title"}>Simple, Transparent Pricing</h1>
                    <span className={"welcomepage-section-subtitle"}>No hidden fees, no credit card required. Forever.</span>
                </div>
                <div className={"pricing-card"}>
                    ...
                    <a href="/app" className={"get-started-btn pricing-get-started-btn"}>Get Started Now</a>
                </div>
            </div>
            <div className={"welcomepage-opensource welcomepage-section"} id={"open-source"}>
                ...
                <div className={"welcomepage-section-header"}>
                    <h1 className={"welcomepage-section-title"}>Built in the Open</h1>
                    <span className={"welcomepage-section-subtitle"}>Taskly is completely open-source and community-driven. Transparent, secure, and free forever.</span>
                </div>
                <div className={"welcomepage-opensource-cards"}>
                    <div className={"opensource-card"}>
                        <div className={"opensource-card-icon"}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 stroke="currentColor"
                                 strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                                 className="lucide lucide-github size-7 text-[#0E6BA8]">
                                <path
                    ...
                    <div className={"opensource-card"}>
                        <div className={"opensource-card-icon"}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 stroke="currentColor"
                                 strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                                 className="lucide lucide-heart size-7 text-[#0E6BA8]">
                                <path
                    ...
                    <div className={"opensource-card"}>
                        <div className={"opensource-card-icon"}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                 stroke="currentColor"
                                 strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                                 className="lucide lucide-code size-7 text-[#0E6BA8]">
                                <polyline points="16 18 22 12 16 6"></polyline>
                                <polyline points="8 6 2 12 8 18"></polyline>
                            </svg>
                        </div>
                ...
                <div className={"opensource-buttons"}>
                    ...
                    <a className={"welcomepage-header-btn view-gb-btn"} href="https://taskly-1.gitbook.io/docs/" target={"_blank"}>
                        <svg fill="currentColor" viewBox="0 0 25 25" width="24" height="24" role="img" xmlns="http://www.w3.org/2000/svg">
                            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path
                        ...
                        <span>Watch documentation</span>
                    </a>
                </div>
            </div>
            <div className={"welcomepage-getstarted welcomepage-section"}>
                <div className={"get-started-card"}>
                    <h1 className={"get-started-title"}>Ready to Get Started?</h1>
                    <span className={"get-started-subtitle"}>Join teams around the world using Taskly to ship better products faster. No credit card required.</span>
                    <a className={"welcomepage-header-btn get-started-btn"} href="/app">
                        <span>Get Started</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                             strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
